...
import { type Props as SubNavigationProps, SubNavigation } from '#components/SubNavigation'
...
import { getProductWithVariants, type LocalizedProductWithVariant } from '#utils/products'
...
const ProductList: React.FC<{ hasSidebar: boolean }> = ({ hasSidebar }) => {
  ...
  if (products.length === 0) {
    return (
      <div className='w-full py-20 text-center text-lg text-neutral-500'>
        {i18n.t('general.noProducts')}
      </div>
    )
  }
