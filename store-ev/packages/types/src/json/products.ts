...
type RawDataProductSchema = z.ZodObject<{
   ...
   * 
   * The `variantCode` is used for grouping similar products in the storefront listing page.
   ...
   * @example
   * {
   *   "sm": ["https://res.cloudinary.com/...small.webp"],
   *   "lg": ["https://res.cloudinary.com/...large.webp"]
   * }
   */
  images: z.ZodObject<{
    sm: z.ZodArray<z.ZodString>
    lg: z.ZodArray<z.ZodString>
  }>,
 ...
 * 
 * Products need to be assigned to a `taxon` to be visible in the storefront.
 */
